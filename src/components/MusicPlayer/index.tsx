    ...
    <div className="relative sm:px-12 px-8 w-full flex items-center justify-between">
      ...
      <div className="flex-1 flex flex-col items-center justify-center">
        ...
        <Player
          ...
          onTimeUpdate={(event: React.ChangeEvent<HTMLAudioElement>) => setAppTime(event.target.currentTime)}
          onLoadedData={(event: React.ChangeEvent<HTMLAudioElement>) => setDuration(event.target.duration)}
        />
      </div>
      <VolumeBar
        value={volume}
